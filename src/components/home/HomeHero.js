                        ...
                        <div className="img-text">
                            <div className="second-text px-md-5 py-md-5 px-sm-4 py-sm-4 px-3 py-3">
                               <span className='for-desktop'>
                                ...
                                <span className='for-mobile'>Hi! The Carbon Trading Platform using Blockchain aims to facilitate carbon credit trading by creating an unchangeable and tamper-proof record of transactions, automating the exchange of carbon credits, and supporting sustainable development.</span>
