    ...
    <>
      <div className="container-fluid MPPageBg">
        <div className="MPPage-content pb-4">
          <div className="MPPage-head pb-3 pb-sm-4 d-flex justify-content-center align-items-center">
              ...
              <div className="MPPage-content-box row">
                {filteredData.length > 0 ? (
                  filteredData.map((item, key) => (
                    <div
                      className="MPPage-content-data  col-6 col-md-5 my-3"
                      key={key}
                    >
                      <label className="MPPage-Prop-Label">Type:</label>{" "}
                      <span>{item[3] ? "Emission" : "Offset"}</span> <br />
                      <label className="MPPage-Prop-Label">
                        Description:
                      </label>{" "}
                      <span>{item[1]}</span>
                      <br />
                      ...
                      <span>{hexToTimestamp(item[9]._hex)}</span>
                      <br />
                      <div className="MPPage-VM-Btn-class d-flex justify-content-center">
                        <button
                          className="MPPage-VM-Btn mt-2"
                          onClick={() =>
                            navigate("/proposalData", { state: { data: item } })
                          }
                        >
                          Open
                        </button>
